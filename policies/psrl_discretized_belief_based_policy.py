...
class PSRLDiscretizedBeliefBasedPolicy(Policy, ABC):
    ...
    def __init__(self,
        ...
        self.previous_discretized_belief = None
        self.previous_discretized_belief_index = None
    ...
    def discretized_belief_update(self, pulled_arm, observation_index):
        ...
        self.previous_discretized_belief = self.discretized_belief
        self.previous_discretized_belief_index = self.discretized_belief_index
    ...
    def update_belief_from_samples(self, action_obs_samples: np.ndarray):
        ...
        if action_obs_samples is not None:
