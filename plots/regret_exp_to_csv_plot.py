...
if __name__ == '__main__':
    ...
    dict = {
        'x_axis': x_axis[x_axis_mask],
        'mean_optimistic_regret': mean_cumulated_optimistic_regret[x_axis_mask],
        'lower_bound_opt': lower_bound_opt[x_axis_mask],
        'upper_bound_opt': upper_bound_opt[x_axis_mask],
        'mean_spectral_regret': mean_cumulated_spectral_regret[x_axis_mask],
        'lower_bound_spec': lower_bound_spec[x_axis_mask],
        'upper_bound_spec': upper_bound_spec[x_axis_mask],
        'mean_psrl_regret': mean_cumulated_psrl_regret[x_axis_mask],
        'lower_bound_psrl': lower_bound_psrl[x_axis_mask],
        'upper_bound_psrl': upper_bound_psrl[x_axis_mask],
    }

    df = pd.DataFrame(dict)

    if save_files:
        df.to_csv('ICML_experiments_files/regret_info.csv', index=False)
