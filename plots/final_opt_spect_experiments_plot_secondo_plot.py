...
if __name__ == '__main__':
    ...
    base_path = ('ICML_experiments/3states_3actions_3obs/pomdp1/regret/'
                         '0.02stst_0.05_minac_final')

    basic_info_path = base_path + "/basic_info.json"
    oracle_opt_info_path = base_path + "/400_init"
    spect_info_path = base_path + "/8000_25000_init"
    num_experiments = 5
    num_episodes = 8
