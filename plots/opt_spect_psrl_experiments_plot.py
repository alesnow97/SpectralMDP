...
if __name__ == '__main__':
    ...
    pompd_num = 25
    base_path = (f'ICML_experiments/3states_3actions_3obs/pomdp{pompd_num}/regret/'
                         '0.02stst_0.05_minac')
    ...
    min_num_samples = np.min([psrl_collected_samples.shape[0],
    ...
    x_axis = [i for i in range(oracle_collected_samples.shape[0])]
